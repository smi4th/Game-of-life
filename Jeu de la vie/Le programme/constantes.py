...
TAILLEFENETRE = (1440, 900)
TAILLEFENETRE_X = TAILLEFENETRE[0]
TAILLEFENETRE_Y = TAILLEFENETRE[1]

tile_size = 30 #la taille en pixel d'une tuile (case)
nb_case_x = TAILLEFENETRE_X//tile_size #le nombre de cases en x
nb_case_y = TAILLEFENETRE_Y//tile_size #le nombre de cases en y

ACTUAL_CONF = 0
#CONF_LIST = [f[:-4] for f in os.listdir('struct/*')]
CONF_LIST = ['BLOC','CANON','CLIGNOTANT','GALAXIE','GRENOUILLE','PENTADECHATION','PLANEUR','RUCHE','VAISSEAU','X']
